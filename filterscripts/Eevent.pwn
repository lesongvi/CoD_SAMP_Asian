...
public OnFilterScriptInit()
{
    print("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    print("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
    print("TEventSystem Made By : XtremeR");
    print("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    print("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
...
CMD:openevent(playerid)
{
    ...
    SendClientMessageToAll ( 0xFF00FFFF,"[ EVENT ] : EVENT OPEN BY ADMIN TO ENTER USE ' /JOIN ' !" ) ;
    SendClientMessageToAll ( 0xFFFFFFFF," " ) ;
    return 1;
}
// =============================================================================
...
CMD:join(playerid)
{
   ...
   TheEvenT [ playerid ] = true ;
   ResetPlayerWeapons ( playerid ) ;
   format ( iString2 , sizeof ( iString2 ) , "{FFFFFF}' %s ' {F81414}has joined the event.{FFFFFF}( /join )", GetPName ( playerid ) ) ;
...
CMD:ecmd(playerid, params[])
{
   ...
   strcat(EvenTHelP,"{c6a65a}/join  {FFFFFF}Going To The Event\n{c6a65a}/Eventhidenick {FFFFFF}The nick's will be hidden in the event");
   strcat(EvenTHelP,"{c6a65a}/first /second /third {FFFFFF}To give the reward to the first second and third place\n");
